...
5. In the control panel, set the center frequency to your local commercial FM band (about 88-108 MHz), and confirm the sample rate is 1.8 MHz. Tune around and find a strong local FM station. Note how wide the signal looks on the display (it should be roughly 200 kHz). 
